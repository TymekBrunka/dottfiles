...
selected=$(echo "$all_windows" | rofi -i -dmenu -theme /usr/share/rofi/themes/android_notification.rasi | awk '{print $1}')
# selected=$(echo "$all_windows" | wofi --show dmenu /usr/share/rofi/themes/android_notification.rasi | awk '{print $1}')
